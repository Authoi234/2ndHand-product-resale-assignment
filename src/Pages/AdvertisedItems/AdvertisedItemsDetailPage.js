...
import { FaDollarSign, FaHandPointRight, FaHandPointUp } from 'react-icons/fa';
...
import leftPointingImg from '../../assets/images/download-removebg-preview-man.png'
...
const CategoryItemDetailPage = () => {
    ...
    return (
        <div className='lg:flex lg:justify-center lg:items-center text-white' style={{ backgroundImage: `url(${bg})` }}>
            <div className='lg:w-5/12 w-auto mx-16 lg:mx-auto text-start'>
                ...
                <div className='flex justify-center items-center'>
                    <div className='flex'>
                        <div>
                            <h1 className='text-2xl font-semibold text-red-500'>Buy Buy Buy!</h1>
                            <h2 className='text-lg font-medium'>This Is Very Good Product</h2></div>
                        <div className='w-8 ml-1'>
                            <img className='w-full' src={leftPointingImg} alt="" />
                        </div>
                    </div>
                </div>
            ...
            <dialog id="order-booking-modal-on-detail-page" className="modal">
                <div className="modal-box">
                    <form onSubmit={handleOrderSubmit} className='text-black'>
                        ...
                        <button type="submit" className='btn btn-primary my-2 mx-2 animate-pulse'>Submit</button><div className='flex justify-center'><FaHandPointUp className='text-2xl text-orange-300 animate-bounce'></FaHandPointUp></div>
